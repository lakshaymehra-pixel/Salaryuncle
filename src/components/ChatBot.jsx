  ...
  return (
    <div className="flex items-end gap-2 mb-3">
      <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border-2 border-white shadow-sm">
        <img src="https://api.dicebear.com/7.x/bottts/svg?seed=myra&backgroundColor=0d9488" alt="Myra" className="w-full h-full"/>
      </div>
    ...
    <>
      ...
      {open && (
        <div className="fixed bottom-24 left-6 z-50 flex flex-col rounded-3xl shadow-2xl overflow-hidden"
          style={{width:'360px', maxWidth:'calc(100vw - 24px)', height:'520px', background:'#f0fdf9'}}>
          ...
          <div className="flex items-center gap-3 px-5 py-4 flex-shrink-0"
            ...
            <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-white/40 flex-shrink-0 shadow-md">
              <img src="https://api.dicebear.com/7.x/bottts/svg?seed=myra&backgroundColor=0d9488" alt="Myra" className="w-full h-full bg-teal-600"/>
            </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            {/* Quick replies — show after first bot message */}
            {showQuick && messages.length > 0 && !loading && (
              <div className="mt-3">
                <p className="text-xs text-gray-400 mb-2 ml-10">Quick questions:</p>
